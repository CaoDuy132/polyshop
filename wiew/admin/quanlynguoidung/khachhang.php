...
<head>
    ...
    <script src="/wiew/public/js/quanlykhachhang.js"></script>
                   ...
                   <div class="mid">
                        ...
                        <div class="action" style="justify-content: flex-end;">
                              <div class="tieuchi">
                                ...
                                <select name="" id="select">
                                    ...
                                    <option value="DESC" >Mua hàng nhiều nhất</option>
                                    <option value="ASC" >Mua hàng ít nhất</option>
                                </select>
                              </div>
                        </div>
                        <table class="table table-striped" style="margin-top: 2em;">
                             <thead>
                                ...
                                <th scope="col">Lượt mua hàng</th>
                             </thead>
                             <tbody id="hienthikhachhang">
                                 <!-- <tr>
                                 ...
                                 <?php 
                                      if(!empty($data['danhsachkhachhang'])){
