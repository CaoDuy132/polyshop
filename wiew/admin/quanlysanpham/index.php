...
<head>
    ...
    <script src="/wiew/public/js/quanlysanpham.js"></script>
        ...
        <main class="content">
             ...
             <div class="right">
                   <div class="mid">
                        ...
                        <div class="action">
                              <button><a href="/admin/sanpham/themsanpham"> Thêm +</a></button>
                              <div class="box-search">
                                     <input type="email" class="form-control" id="input-search" aria-describedby="emailHelp" placeholder="Tìm kiếm sản phẩm">
                              </div>
                              <div class="tieuchi">
                                ...
                                <select name="" id="select">
                                    ...
                                    <?php 
                                        ...
                                        //      echo '<option value="'.$item['idDM'].'" >'.$item['TenDanhMuc'].'</option>';
                                        // }
                                    ?>
                                </select>
                              </div>
                        ...
                        <div id="phantrang">
                               <?php 
                                   ...
                                   $sotrang = ceil($_SESSION['soluongsp'] / 10);
                                   if($sotrang > 1){
                                        $prev = (int)$page - 1;
                                        $next = (int)$page + 1;
                                        if($page > 1){
                                             echo '<a href="admin/&page='.$prev.'"><button class="btn_phantrang btn btn-info " data-page="'.$prev.'"><i class="fas fa-angle-left"></i></button></a>';

                                        }
                                        for($i = 1; $i<=$sotrang; $i++){
                                             if($page == $i){
                                                  echo '<a href="admin/&page='.$i.'"><button  class="btn_phantrang btn btn-primary " data-page="'.$i.'">'.$i.'</button></a>';    
                                             }else{
                                                  echo '<a href="admin/&page='.$i.'"><button  class="btn_phantrang btn btn-info " data-page="'.$i.'">'.$i.'</button></a>';
                                             }

                                        }
                                        if($page < $sotrang){
                                             echo '<a href="admin/&page='.$next.'"><button class="btn_phantrang btn btn-info " data-page="'.$next.'"><i class="fas fa-angle-right"></i></button></a>';
                                        }
                                   }
