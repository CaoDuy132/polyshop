...
<head>
    ...
    <script src="/wiew/public/js/themsanpham.js"></script>
                           ...
                           <form onsubmit="return false">
                              <div class="top shadow-none p-3 mb-5 bg-light rounded">
                                <div class="form-group">
                                     ...
                                     <input id="tensp" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tên sản phẩm">
                                     <small id="tensp-erro" class="form-text text-muted erro">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                     <label for="exampleInputPassword1">Giá *</label>
                                     <input id="gia" type="text" class="form-control" id="exampleInputPassword1" placeholder="Giá">
                                ...
                                <div id="wrapper-box-mausac">
                                    <div class="box-mausac shadow-none p-3 mb-5 bg-light rounded">
                                        <button type="button" class="btn-close close-box-mausac" aria-label="Close"></button>
                                        <h5>Màu sắc.</h5>
                                ...
                                <div class="box-btn-themmausac">
                                     <button id="themmausac" type="button" class="btn btn-success">+ Thêm màu sắc</button>
                                </div>
