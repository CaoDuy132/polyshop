          ...
          <div id="form-login" class="form-login">
               <div class="form-login-action fadeInDown">
                         ...
                         <div class="wrapper-input">
                              ...
                              <input id="password-login" type="password" placeholder="Mật khẩu" autocomplete="off">
                              <input id="submit-login" type="submit" value="Đăng nhập">
                         </div>
                         <div class="form-login-item-dangky">
                              <p><a  href="user/khoiphuctaikhoan">Quên mật khẩu?</a></p>
                              <p><a  href="user/dangky">+Đăng ký</a></p>
                         </div>
                         <!-- style="color: #ff5c62;" -->
               </div>
          </div>
                    ...
                    <div class="header-top-wrapper">
                         ...
                         <div class="box header-menu-left">
                              ...
                              <div class="user" style="border: none;"
                                      <?php if($data['user'] == false || $data['user']->num_rows == 0){
                                      ...
                                      ?>>
                                   <?php
                                        if($data['user'] == false || $data['user']->num_rows == 0){
                              ...
                              <div style="display: none;" class="user-connect ">
                                   ...
                                   <div class="bot">
                                        <a href="user/thongtindonhang"><p style="margin-top: 0;">Thông tin đơn hàng</p></a>
                                        <a href="user"><p>Thông tin cá nhân</p></a>
